...
import com.tdkj.RNS.entity.ImageType;
import com.tdkj.RNS.exception.RnsException;
import com.tdkj.RNS.properties.RnsProperties;
import com.tdkj.RNS.properties.ValidateCodeProperties;
...
public class ValidateCodeUtil {
    ...
    public void check(String key, String value) throws Exception {
        ...
        if (StringUtils.isBlank(value)) {
            throw new RnsException("请输入验证码");
        }
        if (codeInRedis == null) {
            throw new RnsException("验证码已过期");
        }
        if (!StringUtils.equalsIgnoreCase(value, String.valueOf(codeInRedis))) {
            throw new RnsException("验证码不正确");
        }
    }
